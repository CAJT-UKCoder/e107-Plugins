...
switch($_GET['action']){
	case 'do_add':
		if($_POST['submit']){
			...
			$sql->db_Insert("roster_members", "'', '".$_POST['m_name']."', '".$_POST['m_image']."', '".$enlisted."', '".$_POST['m_rank']."', '".$rank[3]."', '".$rankdate."', '".$_POST['m_group']."', '".$_POST['m_serial']."', '".$_POST['m_uassign']."', '".$_POST['m_ureport']."', '".$_POST['m_dassign']."', '".$_POST['m_dreport']."', '".$_POST['m_status']."', '".$_POST['m_pfile']."', '".$_POST['m_afile']."', '".$_POST['m_loc']."', '".$_POST['m_xfire']."', ''");
